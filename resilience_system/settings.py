...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-change-this-in-production-enterprise-key')
...
#         'NAME': os.environ.get('DB_NAME', 'resilience_db'),
#         'USER': os.environ.get('DB_USER', 'resilience_user'),
